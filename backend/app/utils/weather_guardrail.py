...
_WEATHER_PHRASES: list[str] = [
    ...
    "umbrella", "raincoat", "jacket", "coat", "sweater", "wear", "clothes", "outfit",
    "outdoor", "outside", "outing", "picnic", "hike", "trek", "run", "running", "jog", "walk",
    "cycling", "bike", "swim", "swimming", "drive", "driving", "flight", "fly",
    ...
    # Sky / atmospheric
    "sky", "atmosphere", "precipitation", "condition", "conditions",
    # Alert words
